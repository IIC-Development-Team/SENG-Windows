...
void Graphics::ProcessMesh(aiMesh* pMesh, const aiScene* scene, Mesh& mesh)
{
...
void Graphics::ProcessNode(aiNode* node, const aiScene* scene, Mesh& mesh)
{
...
void Graphics::OnSceneStart()
{
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
	glClearColor(0.0f, 0.2f, 0.6f, 1.0f);
}

void Graphics::OnSceneEnd(GLFWwindow* wnd)
{
	glfwSwapBuffers(wnd);
}

void Graphics::OnShaderCompile(Shader& shader)
{
...
void Graphics::OnShaderSet(Shader& shader)
{
...
void Graphics::OnMeshCreate(Mesh& mesh)
{
...
void Graphics::OnMeshDraw(Mesh& mesh)
{
...
void Graphics::OnSetCamera(Camera camera)
{
...
void Graphics::OnMeshLoad(std::string file, Mesh& mesh)
{
	Assimp::Importer imp;
...
void Graphics::OnLoadTexture(Texture& tx)
{
...
void Material::LoadColor(std::string file)
{
